...
// Requête pour récupérer les 12 demandes récentes triées par date
$sqlRecentDemandes = "SELECT NomDmd, NumeroTel, TypeDmd, DateRdv, Etat FROM demandeur ORDER BY DateRdv DESC LIMIT 12";
...
$demandesNonRetirees = 0; // Valeur par défaut si la requête échoue
...
// Vérification de la validité du résultat
$totalRetraits = 0; // Valeur par défaut si la requête échoue
if ($resultRetraits) {
...
<head>
    ...
    <title>Gestion des demnades | IEPP TSEVIE</title>
    <!-- ======= Styles ====== -->
...
<body>
            ...
            <ul>
                <li>
                    <a href="#">
                        ...
                        <span class="title">IEPP TSEVIE</span>
                    </a>
                </li>
                <li>
                    <a href="#">
    ...
    <?php if ($_SESSION['Poste'] === 'Inspecteur'): ?>
        <li>
...
<div class="session-info">
    ...
    if (isset($_SESSION['NomComplet']) && isset($_SESSION['Poste'])) {
        echo "<span>Bonjour, " . htmlspecialchars($_SESSION['NomComplet']) . " (" . htmlspecialchars($_SESSION['Poste']) . ")</span>";
    } else {
    ...
    ?>
            ...
            <div class="cardBox">
                <div class="card">
                    <div>
                        ...
                        <div class="cardName">Nombre total de demandes</div>
                    </div>
                    <div class="iconBx">
                ...
                <div class="card">
                    <div>
                        ...
                        <div class="cardName">Nombre total de retraits</div>
                    </div>
                    <div class="iconBx">
                ...
                <div>
                    ...
                    <div class="cardName">Demandes non retirées</div>
                </div>
                <div class="iconBx">
                <ion-icon name="swap-horizontal-outline"></ion-icon>
                </div>
            ...
            if ($totalDemandes > 0) {
                ...
                echo round($pourcentageTraitement, 2) . '%'; // Affichage du pourcentage avec 2 décimales
            } else {
